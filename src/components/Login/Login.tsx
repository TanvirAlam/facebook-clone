    ...
    <section className="h-screen">
        <div className="container px-6 py-12 h-full">
            ...
            <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
                <Image src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" className="w-full" alt="Phone image" width="300" height="300"/>
            </div>
            <div className="md:w-8/12 lg:w-5/12 lg:ml-20">
                ...
                <button className="px-7 py-3 text-white bg-pink-500 font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3"
                    role="button"
                    data-mdb-ripple="true"
                    data-mdb-ripple-color="light"
                    onClick={signIn}
